...
import { CarModel, CardTitle, DescText, Description, TitleMain } from '../CarsList/CarsItem/CarsItem.styled';
            ...
            <ModalContainer className="show">
                <ContentContainer>
                    ...
                    <InfoWrapper>
                        ...
                        <StyledLink href="tel:380730000000" width={168} height={44} >Rental car</StyledLink>
                    </InfoWrapper>
                </ContentContainer>
            </ModalContainer>
        </Backdrop>,
